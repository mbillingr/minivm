// TODO:
//   1. Remove Expr::LetMut: It's going to be simpler to make all
//      variables immutable at this abstraction level. Mutable
//      values will still be created as cells, but explicitly with
//      some kind of make-cell and cell-get/set primitives. The
//      abstraction of mutable variables over cells will probably
//      be more suitable at the level of the AN-lang, where conversion
//      into A-normal form happens.
...
impl Prog {
    pub fn new(function_definitions: Vec<FunctionDefinition>, body: Expr) -> Self {
        Prog {
